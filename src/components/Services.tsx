...
export default function Services() {
  return (
    <section id="servicos" className="py-16 sm:py-24 lg:py-32 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-light text-gray-900 mb-4 sm:mb-6 lg:mb-8">
            ...
            return (
              <div key={index} className={`grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center ${!isEven ? 'lg:grid-flow-col-dense' : ''}`}>
                ...
                <div className={`space-y-6 sm:space-y-8 ${!isEven ? 'lg:col-start-2' : ''}`}>
                  <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gray-100 rounded-xl sm:rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-base sm:text-lg text-gray-600 leading-relaxed font-light mb-6 sm:mb-8">
                      {service.description}
                    </p>
                  </div>
                  ...
                  <WhatsAppButton
                    ...
                    className="group bg-black hover:bg-gray-800 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium transition-all duration-300 inline-flex items-center text-sm sm:text-base"
                  >
                    Saber Mais
                ...
                <div className={`order-first lg:order-none ${!isEven ? 'lg:col-start-1' : ''}`}>
                  <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl sm:rounded-3xl overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                      <Icon className="h-16 w-16 sm:h-20 sm:w-20 lg:h-24 lg:w-24 text-gray-400" />
                    </div>
                  </div>
                </div>
              </div>
