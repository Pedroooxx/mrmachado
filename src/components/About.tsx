    ...
    <section id="sobre" className="section-padding bg-white">
      <div className="container-responsive">
        ...
        <div className="text-center mb-16 sm:mb-20 lg:mb-24">
          ...
          <p className="text-body-large text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
        ...
        <div className="grid-responsive-2 mb-16 sm:mb-20 lg:mb-24">
          ...
          <div className="space-y-6 sm:space-y-8">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-light text-gray-900">
          ...
          <div className="order-first lg:order-none">
            <div className="aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl sm:rounded-3xl overflow-hidden">
              <div className="w-full h-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                <div className="text-center">
                  <Award className="h-16 w-16 sm:h-20 sm:w-20 lg:h-24 lg:w-24 text-gray-400 mx-auto mb-4" />
                  <p className="text-gray-500 font-medium">15+ Anos de Excelência</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gray-100 rounded-2xl sm:rounded-3xl mb-4 sm:mb-6">
                  <Icon className="h-8 w-8 sm:h-10 sm:w-10 text-gray-900" />
                </div>
                <div className="text-3xl sm:text-4xl lg:text-5xl font-light text-gray-900 mb-2 sm:mb-3">
                  {stat.number}
                </div>
        ...
        <div className="mb-16 sm:mb-20 lg:mb-24">
          <div className="text-center mb-12 sm:mb-16">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-light text-gray-900 mb-4 sm:mb-6">
        ...
        {/* CTA */}
        <div className="text-center card-responsive bg-gray-50">
